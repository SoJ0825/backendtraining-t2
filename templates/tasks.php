            ...
            <div class="container row pr-0 border-bottom mb-2 mx-0 px-0 d-flex justify-content-center col-md-12">
                ...
                <div class="col-md-3 p-1">
                    <div class="container-fluid p-0">                    
                        <a href="http://localhost/backendtraining-t2/process/completed/{$taskData['id']}" class='btn btn-success btn-block my-1'><i class="fa fa-btn fa-thumbs-o-up"></i>Completed</a>
                    </div>
                ...
                <a href="http://localhost/backendtraining-t2/process/delete/{$taskData['id']}" class='btn btn-danger btn-block my-1 ml-1'><i class="fa fa-btn fa-trash"></i>Delete</a>
                 </div>
                </div>
            </div>
            EOT;
