    ...
    foreach ($tasks->read() as $task) {
        if (!$task['t_fulfil'] == 0) {
            ...
            <div class="container row pr-0 border-bottom mb-2 mx-0 px-0 d-flex justify-content-center col-md-12">
                ...
                <div class="col-md-3 p-1">
                  ...
                  <div class="container-fluid d-flex justify-content-center p-0">
                        ...
                        <a href="process.php?send=delete&t_id={$task['t_id']}" class='btn btn-danger btn-block my-1 ml-1'><i class="fa fa-btn fa-trash"></i>Delete</a>
                    </div>
                </div>
            </div>
            EOT;
            ...
            <div class="container row pr-0 border-bottom mb-2 mx-0 px-0 d-flex justify-content-center col-md-12">
                ...
                <div class="col-md-3 p-1">
                    <div class="container-fluid p-0">                    
                        <a href="process.php?send=fulfil&t_id={$task['t_id']}" class='btn btn-success btn-block my-1'><i class="fa fa-btn fa-thumbs-o-up"></i>Completed</a>
                    </div>
                <div class="container-fluid d-flex justify-content-center p-0">
                        <a href="edit.php?t_id={$task['t_id']}" class='btn btn-primary btn-block my-1 mr-1'><i class="fa fa-btn fa-pencil"></i>Edit</a>
                        <a href="process.php?send=delete&t_id={$task['t_id']}" class='btn btn-danger btn-block my-1 ml-1'><i class="fa fa-btn fa-trash"></i>Delete</a>
                 </div>
                </div>
            </div>
